...
class GraphBuilder:
    ...
    def build_original_graph(self, building, obstacles):
        """
        ...
        Returns:
            networkx DiGraph
        """
        self.logger.info("Building original (non-rotated) grid graph for thesis plots")
        
        # Temporarily disable rotation
        original_rotation_enabled = self.rotation_enabled
        ...
        # Generate grid points without rotation
        grid_points = self._generate_grid_points(building, inner_buffer, outer_buffer, obstacles)
        ...
        self.rotation_enabled = original_rotation_enabled
        self.rotation_angle = original_rotation_angle
        
        self.logger.info(f"Created original graph with {G.number_of_nodes()} nodes and {G.number_of_edges()} edges")
        
        return G
    
    def build_rotated_graph(self, building, obstacles, rotation_angle, rotation_center):
        """
        ...
        Returns:
            networkx DiGraph
        """
        self.logger.info("Building rotated grid graph for thesis plots")
        
        # Temporarily set rotation parameters
        original_rotation_enabled = self.rotation_enabled
        original_rotation_angle = self.rotation_angle
        original_rotation_center = self.rotation_center
        ...
        # Generate grid points with rotation
        grid_points = self._generate_grid_points(building, inner_buffer, outer_buffer, obstacles)
        ...
        self.rotation_enabled = original_rotation_enabled
        self.rotation_angle = original_rotation_angle
        self.rotation_center = original_rotation_center
        
        self.logger.info(f"Created rotated graph with {G.number_of_nodes()} nodes and {G.number_of_edges()} edges")
