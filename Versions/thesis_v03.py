...
start_point = Point(34, -12)

if (start_point.x, start_point.y) not in point_index_map:
    raise ValueError("Start point is not in the grid set.")
...
plt.scatter([start_point.x], [start_point.y], color='red', label="Start Point", zorder=5)
